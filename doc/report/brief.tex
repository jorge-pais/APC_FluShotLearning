...
\textit{Explicar o contexto do dataset e mostrar algumas das caracteristicas dos dados, explicando algum do preprocessamento necessario a aplicar/ cuidados a ter}
