...
\begin{thebibliography}{00}
    \bibitem{b1} DrivenData, “Flu shot learning: Predict H1N1 and seasonal flu vaccines,” DrivenData. [Online]. Available: https://www.drivendata.org/competitions/66/flu-shot-learning/. [Accessed: 09-Jan-2023].
    %\bibitem{b2}
